...
import com.example.testaoo.adapters.DistrictAdapter;
import com.example.testaoo.data.PerDistrictData;
import com.example.testaoo.models.DistrictModel;
...
public class DistrictwiseDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stateName = intent.getStringExtra(COUNTRY_NAME);
                ...
                try {
                    ...
                    for (int i = 1; i < jsonArray.length(); i++) {
                        ...
                        if (stateName.toLowerCase().equals(jsonObject.getString("state").toLowerCase())) {
                            ...
                            for (int j = 0; j < jsonArray2.length(); j++) {
                                ...
                                districtModelArrayList.add(new DistrictModel(districtName, districtConfirmed, districtRecovered, districtDeceased, districtNewConfirmed, districtNewRecovered, districtNewDeceased));
                    ...
                    Runnable progressRunnable = new Runnable() {
                        ...
                        public void run() {
                            ...
                            //districtAdapter.setOnItemClickListner((DistrictAdapter.OnItemClickListner) DistrictwiseDataActivity.this);
                        }
                    };
